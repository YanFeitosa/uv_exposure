...
class StorageService {
  ...
  static Future<void> saveUserPreferences({
    ...
    if (defaultSkinType != null) {
      await prefs.setString(AppConstants.cacheKeyDefaultSkinType, defaultSkinType);
    }
  }
  ...
  static const String _notificationPermissionAskedKey = AppConstants.cacheKeyNotificationPermission;
